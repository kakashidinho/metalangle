...
def gen_precompiled_shaders(mac_version, ios_version, variable_name, additional_flags, src_files,
    ...
    tvos_metallib = 'compiled/{0}.tvos.metallib'.format(variable_name)
    ...
    for src_file in src_files:
        ...
        os.system('xcrun -sdk appletvos metal -mtvos-version-min={0} {1} {2} -c -o {3}'.format(
            ios_version, additional_flags, src_file, object_file))
    os.system('xcrun -sdk appletvos metallib {object_files} -o {file}'.format(
        file=tvos_metallib, object_files=object_files))

    # tvOS simulator version's compilation
    print('Compiling tvos {0} simulator version of default shaders ...'.format(ios_version))

    tvos_sim_metallib = 'compiled/{0}.tvos_sim.metallib'.format(variable_name)
    ...
    for src_file in src_files:
        ...
        os.system('xcrun -sdk appletvsimulator metal {0} {1} -c -o {2}'.format(
            additional_flags, src_file, object_file))
    os.system('xcrun -sdk appletvsimulator metallib {object_files} -o {file}'.format(
        file=tvos_sim_metallib, object_files=object_files))
    ...
    store_metallib_as_byte_array_and_include(variable_name, copyright_comments, tvos_sim_metallib)
    ...
    store_metallib_as_byte_array_and_include(variable_name, copyright_comments, tvos_metallib)
...
def main():
    ...
    os_specific_autogen_files = [
        ...
        'compiled/compiled_default_metallib_2_1_debug_tvos_autogen.inc',
        'compiled/compiled_default_metallib_2_1_debug_tvos_sim_autogen.inc',
        ...
        'compiled/compiled_default_metallib_2_1_tvos_autogen.inc',
        'compiled/compiled_default_metallib_2_1_tvos_sim_autogen.inc',
        ...
        'compiled/compiled_default_metallib_debug_tvos_autogen.inc',
        'compiled/compiled_default_metallib_debug_tvos_sim_autogen.inc',
        ...
        'compiled/compiled_default_metallib_tvos_autogen.inc',
        'compiled/compiled_default_metallib_tvos_sim_autogen.inc'
    ]
    # yapf: enable
