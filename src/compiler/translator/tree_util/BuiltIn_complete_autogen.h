...
class BuiltInId
{
  public:
    ...
    static constexpr const TSymbolUniqueId gl_ClipDistance          = TSymbolUniqueId(2285);
    static constexpr const TSymbolUniqueId gl_MaxClipDistances      = TSymbolUniqueId(2286);
